...
@configclass
class G1AmpRobustEnvCfg(G1AmpEnvCfg):
    """G1 robot AMP configuration for robust locomotion with remote control and external force resistance."""
...
@configclass
class G1AmpRobustEnvCfg_PLAY(G1AmpRobustEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        self.scene.num_envs = 48
        self.scene.env_spacing = 2.5
